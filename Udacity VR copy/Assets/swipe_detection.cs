		...
		private void MyCallbackMethod( SwipeControl.SWIPE_DIRECTION iDirection ) {
			...
			switch ( iDirection ) {
				case SwipeControl.SWIPE_DIRECTION.SD_RIGHT:
					onboardingScreenController.GetComponent<onboardingScreenControllerPortrait> ().progressBackwards ();
					break;
				case SwipeControl.SWIPE_DIRECTION.SD_LEFT:
					onboardingScreenController.GetComponent<onboardingScreenControllerPortrait> ().progressForwards ();
					break;
