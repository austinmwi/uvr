...
public class onboardingScreenControllerPortrait : MonoBehaviour {
	...
	void Update () {
		...
		screenCanvas.transform.localPosition = Vector3.Lerp(screenCanvas.transform.localPosition, new Vector3 (scrollLine, -38f, 0), fracJourney);
