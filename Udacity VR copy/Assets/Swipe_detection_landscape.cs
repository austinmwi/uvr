...
public class Swipe_detection_landscape : MonoBehaviour {
	...
	public GameObject onboardingScreenController;
	...
	private void MyCallbackMethod( SwipeControl.SWIPE_DIRECTION iDirection ) {
		...
		case SwipeControl.SWIPE_DIRECTION.SD_UP:
			onboardingScreenController.GetComponent<onboardingScreenController> ().progressBackwards ();
			break;
		case SwipeControl.SWIPE_DIRECTION.SD_DOWN:
			onboardingScreenController.GetComponent<onboardingScreenController> ().progressForwards ();
			break;
